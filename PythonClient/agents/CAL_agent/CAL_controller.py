...
from CAL_planner.map import CarlaMap
import logging
...
class CAL(Agent):
    ...
    def __init__(self, city_name, vehicle):
    ...
    def _longitudinal_control(self, prediction, direction) :
        ...
        print("STATE " + state_name + " with prob: " + str(prediction_proba*100))
    ...
    def _get_location_and_orientation(self, measurements):
        ...
        # get the orientation
        veh_ori_x = measurements.player_measurements.transform.rotation.roll,
        veh_ori_y = measurements.player_measurements.transform.rotation.pitch,
